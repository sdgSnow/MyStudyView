...
/**
 * 实现流量球第二步，实现一个无限滚动的水波纹球
 * @author shendaogu
 * */
public class BallFlowView02 extends View {
    ...
    public BallFlowView02(Context context) {
        super(context,null);
    }

    public BallFlowView02(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
