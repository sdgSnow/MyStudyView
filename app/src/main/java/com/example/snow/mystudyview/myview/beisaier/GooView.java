...
//        mPaint.setColor(getResources().getColor(R.color.color_message));
    ...
    private void drawAssistPoint(Path path, PointF[] dragPoints, PointF[] stickPoints) {
        path.addCircle(dragPoints[0].x, dragPoints[0].y, 1, Path.Direction.CW);
        path.addCircle(dragPoints[1].x, dragPoints[1].y, 1, Path.Direction.CW);
        path.addCircle(stickPoints[0].x, stickPoints[0].y, 1, Path.Direction.CW);
        path.addCircle(stickPoints[1].x, stickPoints[1].y, 1, Path.Direction.CW);
    }
