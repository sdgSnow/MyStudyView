...
//        mRectF.bottom = mHeight - mCircleLineStrokeWidth / 2 - 100; // 右下角y
        mRectF.left = MeasureUtil.getScreenSize((Activity) mContext)[0]/2 - 200;
        mRectF.top = MeasureUtil.getScreenSize((Activity) mContext)[1]/2 - 200;
        mRectF.right = MeasureUtil.getScreenSize((Activity) mContext)[0]/2 + 200;
        mRectF.bottom = MeasureUtil.getScreenSize((Activity) mContext)[1]/2 + 200;
